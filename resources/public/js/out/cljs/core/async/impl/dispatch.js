...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12781 = 0;while(true){
var m_12782 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12782 == null))
{} else
{m_12782.call(null);
if((count_12781 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12783 = (count_12781 + 1);
count_12781 = G__12783;
continue;
}
} else
{}
