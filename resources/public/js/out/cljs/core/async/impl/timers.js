...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12746 = 0;while(true){
if((i_12746 < arr.length))
{(arr[i_12746] = null);
{
...
{var i_12753 = (self__.level + 1);while(true){
if((i_12753 <= (new_level + 1)))
{(update[i_12753] = self__.header);
{
var G__12754 = (i_12753 + 1);
i_12753 = G__12754;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12755 = 0;while(true){
if((i_12755 <= self__.level))
{var links_12756 = (update[i_12755]).forward;if(((links_12756[i_12755]) === x__$1))
{(links_12756[i_12755] = (x__$1.forward[i_12755]));
{
