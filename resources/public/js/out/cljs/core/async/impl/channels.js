...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12787 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12787 = (function (val,box,meta12788){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12787.cljs$lang$type = true;
cljs.core.async.impl.channels.t12787.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12787";
cljs.core.async.impl.channels.t12787.cljs$lang$ctorPrWriter = (function (this__3956__auto__,writer__3957__auto__,opt__3958__auto__){return cljs.core._write.call(null,writer__3957__auto__,"cljs.core.async.impl.channels/t12787");
});
cljs.core.async.impl.channels.t12787.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12787.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12789){var self__ = this;
var _12789__$1 = this;return self__.meta12788;
});
cljs.core.async.impl.channels.t12787.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12789,meta12788__$1){var self__ = this;
var _12789__$1 = this;return (new cljs.core.async.impl.channels.t12787(self__.val,self__.box,meta12788__$1));
});
cljs.core.async.impl.channels.__GT_t12787 = (function __GT_t12787(val__$1,box__$1,meta12788){return (new cljs.core.async.impl.channels.t12787(val__$1,box__$1,meta12788));
});
}
return (new cljs.core.async.impl.channels.t12787(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12790 = self__.takes.pop();if((taker_12790 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12790))
{var take_cb_12791 = cljs.core.async.impl.protocols.commit.call(null,taker_12790);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12791,taker_12790){
return (function (){return take_cb_12791.call(null,null);
});})(take_cb_12791,taker_12790))
);
} else
{}
{
