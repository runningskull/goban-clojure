...
{{
var G__9035 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9035;
continue;
}
} else
...
{var pred__9039 = cljs.core._EQ_;var expr__9040 = limit;if(cljs.core.truth_(pred__9039.call(null,1,expr__9040)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__9039.call(null,2,expr__9040)))
...
var G__9042 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9043 = (limit__$1 - 1);
var G__9044 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9042;
limit__$1 = G__9043;
parts = G__9044;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___9046 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___9046))
{var replacement_9047 = temp__4090__auto___9046;buffer.append([cljs.core.str(replacement_9047)].join(''));
} else
{buffer.append(ch);
}
{
